...
/**
 * Concrete implementation of the ConfigurationManager singleton object for the ATBM platform.
 */
class ConfigurationManagerImpl : public Internal::GenericConfigurationManagerImpl<Internal::ATBMConfig>,
#if CHIP_DEVICE_CONFIG_ENABLE_CHIPOBLE
